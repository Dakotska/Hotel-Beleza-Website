...
<body>
    ...
    <h2 class="sct-title">🥞 Desayunos </h2>
    <section class="sec-desayunos">
        <div class="card">
            <img src="/Hotel-Beleza-Website/assets/images/images-food/desayuno1.png" alt="Desayuno Clásico Mexicano">
            <div class="card-down">
                <h1>Desayuno Clásico Mexicano</h1>
                ...
                <ul>
                    ...
                    <li>Plátano macho frito</li>
                </ul>
                <input type="button" value="shopping_cart" onclick="Carrito(1)">
            </div>
        </div>
        <div class="card">
            <img src="/Hotel-Beleza-Website/assets/images/images-food/desayuno2.png" alt="Desayuno Norteño con Salchicha">
            <div class="card-down">
                <h1>Desayuno Norteño con Salchicha</h1>
                <p>Una opción abundante y deliciosa para arrancar el día con energía y buen sabor.</p>
                <ul>
        ...
        <div class="card">
            ...
            <div class="card-down">
                ...
                <p>Ideal para quienes prefieren comenzar el día con algo suave, ligero y sabroso.</p>
                <ul>
    ...
    <h2 class="sct-title">🍽️ Comidas </h2>
    <section class="sec-comidas">
        <div class="card">
            ...
            <div class="card-down">
                ...
                <p>Tortillas rellenas de pollo bañadas en salsa roja casera, con el toque fresco de la cebolla morada y cilantro.</p>
                <ul>
        ...
        <div class="card">
            ...
            <div class="card-down">
                ...
                <p>Clásico poblano de temporada: chile relleno de picadillo suave, cubierto con salsa de nuez y granada fresca.</p>
                <ul>
        ...
        <div class="card">
            ...
            <div class="card-down">
                ...
                <p>Deliciosos tacos de carne adobada al pastor, servidos con piña, cebolla y cilantro, acompañados de salsa.</p>
                <ul>
                    <li>Tortillas de maíz</li>
                    <li>Carne al pastor</li>
                    <li>Piña asada</li>
                    <li>Cebolla y cilantro</li>
                    <li>Rodaja de limón y salsa roja</li>
                </ul>
        ...
        <div class="card">
            ...
            <div class="card-down">
                ...
                <p>Crujientes totopos bañados en salsa verde, coronados con crema, queso fresco y un toque de cilantro.</p>
                <ul>
    ...
    <section class="sec-cenas">
        ...
        <div class="card">
            ...
            <div class="card-down">
                ...
                <p>Tradicionales quesadillas crujientes, rellenas de queso fundido y servidas con salsa y limón fresco.</p>
                <ul>
                    <li>Tortillas de maíz</li>
                    <li>Queso fundido</li>
        ...
        <div class="card">
            ...
            <div class="card-down">
                ...
                <p>Base gruesa de maíz untada con frijoles refritos, lechuga fresca, queso y pico de gallo por encima.</p>
                <ul>
                    <li>Masa gruesa de maíz</li>
                    <li>Frijoles refritos</li>
                    <li>Lechuga</li>
                    <li>Queso fresco</li>
    ...
    <form class="sec-recibo" action="../forms/restaurant.php" method="POST">
        <div class="rec-header"><h1>Puedes ver tu carrito aqui 🛒</h1></div>
        <div class="rec-body">
            <div class="Lista-de-comidas">
                ...
                <p id="mensaje-vacio" style="display: none; color: gray; text-align: center; font-size: 50px;">No hay ningún producto agregado.</p>
            </div>
    ...
    <script>
        ...
        function Carrito(number) {
            ...
            const rplantillas = {
                1: generarRec("Desayuno Clásico Mexicano",           1),
                2: generarRec("Desayuno Norteño con Salchicha",     2),
